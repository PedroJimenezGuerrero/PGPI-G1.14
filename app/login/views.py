...
def login(request):
    ...
    return render(request, 'login/login.html', {'loc':report_loc,'error': ''})
def signin(request):
    ...
    if email in emails:
        ...
        return render(request, 'login/login.html', {'loc':report_loc,'errorclass':'alert alert-danger','error': 'Sorry. No such account exists. Consider signing up!'})